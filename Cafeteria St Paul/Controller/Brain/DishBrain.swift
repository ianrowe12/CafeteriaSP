...
struct dishBrain{
    ...
    //MARK: - Breakfast
    static let pinto = Dish(name: "Gallo Pinto", image: UIImage(imageLiteralResourceName: "galloPinto"), price: "₡2000", description: "Black beans, salsa lizano, red bell pepper, cooked rice, garlic", dayOfWeek: [2, 3, 4, 5, 6])
    static let tortillas = Dish(name: "Tortilla con Natilla", image: UIImage(imageLiteralResourceName: "tortillaConNatilla"), price: "₡2000", description: "Corn tortilla with custard.", dayOfWeek: [2, 3, 4, 5, 6])
    
    //MARK: - Desserts
    static let donut = Dish(name: "Donuts", image: UIImage(imageLiteralResourceName: "donuts"), price: "₡600", description: "Chocolate and Vanilla Donuts", dayOfWeek: [5, 6])
    static let pañuelo = Dish(name: "Pañuelos", image: UIImage(imageLiteralResourceName: "pañuelos"), price: "₡700", description: "Puff pastry combined with the sweet flavor of the stuffed arequipe", dayOfWeek: [4, 5, 6])
    static let cachito = Dish(name: "Cachitos", image: UIImage(imageLiteralResourceName: "cachitos"), price: "₡600", description: "It consists of a soft dough filled with delicacy, pastry cream or with chocolate cream", dayOfWeek: [2, 5, 6])
